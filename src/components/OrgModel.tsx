...
export default function OrgModel({areas}:{areas:Area[]}) { return <div className="org">
  ...
  <Link href="/papeis/ceo" className="orgNode ceoNode" style={{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center"}}><strong>CEO — Paulo</strong><span>Direção, transformação e accountability executiva</span></Link><div className="orgLine"/>
